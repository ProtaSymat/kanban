 ...
 */
final class Version20240412133926 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE task_history (id INT AUTO_INCREMENT NOT NULL, task_id INT DEFAULT NULL, event VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, event_date DATETIME NOT NULL, details VARCHAR(255) NOT NULL, INDEX IDX_385B5AA18DB60186 (task_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
